...
<html>
    <head>
        <title class="center">Festif'Consult - Votre guichet en ligne</title>     
        ...
        <script src="admin/lib/js/functionsMessage.js" type="text/javascript"></script>
        <meta charset='UTF-8'/>
    </head>
    ...
    <body>
        ...
        <div class="container"> 
            ...
            <section id="main">
                <div class="row">
                    <div class="col-sm-12">
                        <h2 class="centrer">Bienvenue chez Festif'Consult</h2>
                    </div>
                </div>
                <?php
